...
class MobileNetSelfAttn(nn.Module):
    def __init__(self, num_classes=10, width_mult=1.0):
        ...
        self.features = nn.Sequential(
            ...
            # SelfAttention(int(512 * width_mult)),
            DenseConnection(512, 512),
            nn.Conv2d(int(1024 * width_mult), int(1024 * width_mult), kernel_size=3, stride=2, padding=1,
        ...
        self.classifier = nn.Sequential(
            nn.Dropout(0.2),
            nn.Linear(int(192 * width_mult), 192),
            nn.Dropout(0.2),
