...
train_set = torchvision.datasets.CIFAR10(
    root='test/data', train=True, download=False, transform=transform_train)
...
test_set = torchvision.datasets.CIFAR10(
    root='test/data', train=False, download=False, transform=transform_test)
